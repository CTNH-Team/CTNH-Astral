...
public class AstralMeteorPlacer {
    ...
    private void placeChest() {
        this.putter.put(level, pos,
                GTMaterialBlocks.MATERIAL_BLOCKS.get(TagPrefix.block, CAMaterials.Starmetal).getDefaultState());
    }
                            ...
                            if (rand >= 0.5) {
                                ...
                                this.putter.put(level, pos,
                                        GTMaterialBlocks.MATERIAL_BLOCKS
                                                .get(CATagPrefixes.oreAstralStone, CAMaterials.Starmetal)
                                                .getDefaultState());
                            }
                            if (dx == 0 && dy == 0 && dz == 0) {}
                        } else {
                    ...
                    if (j > h + distanceFrom * 0.02) {
                        ...
                        if (currentBlock.getBlock() == Blocks.AIR) {
                            this.putter.put(level, blockPos,
                                    CAMaterials.Starlight.getFluid().defaultFluidState().createLegacyBlock());
                        }
