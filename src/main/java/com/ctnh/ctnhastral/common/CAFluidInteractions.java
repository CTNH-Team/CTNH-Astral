...
public final class CAFluidInteractions {
    ...
    public static void register() {
        ...
        FluidInteractionRegistry.addInteraction(acid.getFluid().getFluidType(),
                new FluidInteractionRegistry.InteractionInformation(ForgeMod.WATER_TYPE.get(), Blocks.MUD.defaultBlockState()));
        FluidInteractionRegistry.addInteraction(acid.getFluid().getFluidType(),
                new FluidInteractionRegistry.InteractionInformation(ForgeMod.LAVA_TYPE.get(), Blocks.TUFF.defaultBlockState()));
    }
}
